...
//    if (_s.skeletonPositions[Kinect.NUI_SKELETON_POSITION_HAND_RIGHT].y*500 > yPos && _s.skeletonPositions[Kinect.NUI_SKELETON_POSITION_HAND_RIGHT].y*500 < yPos + sHeight 
//    && _s.skeletonPositions[Kinect.NUI_SKELETON_POSITION_HAND_RIGHT].x*800 > xPos && _s.skeletonPositions[Kinect.NUI_SKELETON_POSITION_HAND_RIGHT].x*800 < xPos + sWidth) {
//      return true;
//    } else {
//      return false;
//    }
